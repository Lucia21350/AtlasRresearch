...
The setup script below is used to install the **prediction15** package. You will need to modify this setup script as follows:
                                                                                              
- Set the `projectRootFolder` variable to the directory specific to your environment. In this example we are using `C:/prediction15`. This root folder will serve a few purposes:
...
download.file("https://raw.githubusercontent.com/ohdsi-studies/prediction15/main/renv.lock", "renv.lock")
...
# finally install the prediction15 package
install.packages('devtools')
devtools::install_github('ohdsi-studies/prediction15')
...
You can safely continue by pressing 'y' after this prompt since the renv.lock file is downloaded from the **prediction15** GitHub code repository. Once the installation is complete, you may need to restart R (if you are working outside of RStudio) and you should see this message:

````
Project 'C:/prediction15' loaded. [renv 0.x.y]
````
