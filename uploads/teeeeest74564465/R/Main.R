...
#'
#' @details
#' This function executes the prediction15 Study.
#' 
  ...
  if(createValidationPackage){
      ...
      tryCatch({
        ...
        createValidationPackage(
          devPackageName = 'prediction15',
          devDatabaseName = databaseDetails$cdmDatabaseName,
          analysisLocation = outputFolder,
          analysisIds = analysesToValidate,
          outputFolder = outputFolder,
          validationPackageName = 'prediction15Validation',
          description = 'validating models in prediction15',
          createdBy = 'anonymous',
