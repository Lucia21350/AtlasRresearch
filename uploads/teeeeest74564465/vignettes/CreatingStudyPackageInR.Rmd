...
- Install the dependencies for the skeleton (source the file at: [https://github.com/OHDSI/prediction15/blob/main/extras/packageDeps.R](https://github.com/OHDSI/prediction15/blob/main/extras/packageDeps.R) )
...
For the json creation you will need to source the code found at: https://github.com/OHDSI/prediction15/blob/main/extras/createPredSkelJson.R to load the function 'createDevelopmentStudyJson'. 
