...
createDevelopmentPackage <- function(
  ...
  baseUrl,
  skeletonLocation,
  skeletonUrl = "https://github.com/ohdsi/prediction15/archive/main.zip",
  outputLocation,
  packageName){
  ...
  file.copy(list.files(skeletonLocation, full.names = TRUE), 
    ...
    #rename
    file.rename(file.path(outputLocation,'prediction15-main'), packageLocation)
  ...
  # replace 'prediction15' with packageName 
  replaceName(
    packageLocation = packageLocation,
    packageName = packageName,
    skeletonType = 'prediction15'
    )
