...
#devtools::source_url("https://raw.github.com/ohdsi/prediction15/issue242/extras/createDevelopmentPackageFunctions.R")
...
createDevelopmentPackage(
  jsonList = jsonList, 
  baseUrl = baseUrl,
  #skeletonLocation = 'D:/GitHub/prediction15', 
  skeletonUrl = "https://github.com/ohdsi/prediction15/archive/master.zip",
