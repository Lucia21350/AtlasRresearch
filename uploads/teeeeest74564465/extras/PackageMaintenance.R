...
#
# This file is part of prediction15
#
...
OhdsiRTools::checkUsagePackage("prediction15")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/prediction15.pdf")
shell("R CMD Rd2pdf ./ --output=extras/prediction15.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("prediction15")
